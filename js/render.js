/* =============================================================================
   ...
   ============================================================================= */
import { items, categoryDefs, savingDefs, MONTHS, fcKeys, SALARY_MIN_CENTS, CARD_TOTAL_CENTS } from './constants.js?v=19';
import { el, fcSliders, fcVals } from './dom.js?v=19';
import { formatCents } from './utils.js?v=19';
import { computeTotals, sumEntries } from './compute.js?v=19';
